...
const psHierarchy = {
    ...
    'FUNCTIONAL (HEAD QUARTER POSTS)': [
        { name: 'DSB, Krishna', isUPS: true, stations: [] },
        { name: 'DCRB, Krishna', isUPS: true, stations: [] },
        { name: 'DTRB, Krishna', isUPS: true, stations: [] },
        { name: 'PCR, Krishna', isUPS: true, stations: [] },
        { name: 'Women PS', isUPS: true, stations: [] },
        { name: 'CCS, Machilipatnam', isUPS: true, stations: [] },
        { name: 'CCS, Gudivada', isUPS: true, stations: [] },
        { name: 'SC/ST Cell', isUPS: true, stations: [] },
        { name: 'D.T.C., MTM', isUPS: true, stations: [] },
        { name: 'Cyber Crime', isUPS: true, stations: [] },
        { name: 'AIRPORT', isUPS: true, stations: [] },
        { name: 'VR., KRISHNA', isUPS: true, stations: [] },
    ],
};
